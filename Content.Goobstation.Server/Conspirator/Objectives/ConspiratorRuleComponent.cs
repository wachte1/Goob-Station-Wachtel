...
using Content.Goobstation.Server.Conspirator;

namespace Content.Goobstation.Server.Conspirator.Objectives;

[RegisterComponent, Access(typeof(ConspiratorRuleSystem))]

public sealed partial class ConspiratorRuleComponent : Component
{
    public readonly List<EntityUid> ConspiratorMinds = new();
    ...
    [DataField]
    public ProtoId<DatasetPrototype> ObjectiveIssuers = "TraitorFlavor"; // Goobstation - Use same flavour as 
    ...
    public int TotalConspirators => ConspiratorMinds.Count;
